...
class _EntryPageState extends State<EntryPage> {
  ...
  void initState() {
    ...
    final start = widget.entry?.start ??
        DateTime.now(); //for editing ,getting value form data model
    _startDate = DateTime(
        start.year, start.month, start.day); //getting current time convenience
  ...
  Entry _entryFromState() {
    //this function is used because we do not use Form widget
